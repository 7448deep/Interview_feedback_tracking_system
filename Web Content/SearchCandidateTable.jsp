...
<%@page import="com.web.SearchCandidate"%>
...
<body style="background-color: #f0f0f0">
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col">
				<div class="row m-1">
					<div class="card  p-4 " style="background-color: #5cd1f7">
						<div class="row">
							<!-- starting of search by -->
							<div class="col-5">
								<div class="row">
							...
							<!-- Ending of search by -->
							<div class="col-7">
								<!-- Starting of search by candidate -->
								<div id="SearchByCandidateDiv" style="display: none">
									<div class="row">
										<div class="col-3"><strong>Search by Candidate</strong></div>
										<div class="col-7">
											<form onsubmit="return validateFirstSelectForm()" action="searchcandidate" method="post">
								...
								<!-- ending of search by candidate -->
								<!-- starting of search by interviewer -->
								<div id="SearchByInterviewerDiv" style="display: none">
									<div class="row">
										<div class="col-4"><strong>Search by Interviewer</strong></div>
										<div class="col-7">
											<form onsubmit="return validateSecondSelectForm()" action="searchcandidate" method="post">
								...
								<!-- ending of search by interviewer -->
								<!-- starting of search by JobRole -->
								<div id="SearchByJobRoleDiv" style="display: none">
									<div class="row">
										<div class="col-3"><strong>Search By JobRole</strong></div>
										<div class="col-7">
											<form onsubmit="return validateThirdSelectForm()" action="searchcandidate" method="post">
								...
								<!-- ending of search by JobRole -->
								<!-- starting of search by Date -->
								<div id="SearchByDateDiv" style="display: none">
									<div class="row">
										<div class="col-3"><strong>Search By Date</strong></div>
										<div class="col-9">
											<form onsubmit="return validateForthSelectForm()" action="searchcandidate" method="post">
								...
								<!-- Ending of search by Date -->
								<!-- starting of search by Selected -->
								...
								<!-- Ending of search by Selected -->
								<!-- starting of search by rejected -->
								...
								<!-- Ending of search by rejected -->
								
							</div>
							<!-- ending of col-right part -->
						</div>
				...
				<div class="row m-4">
					<div class="col-md-8 offset-md-2">
						<div class="candidate_list">
							<div class="card p-2" style="background-color: #e3f4fc">
								<div class="card-body">


									<%
									ArrayList<Candidate> candidatelist = (ArrayList<Candidate>) session.getAttribute("candidatedata");
									...
									<div class="row ">
										...
										<div class="col-4">
											<%
											out.print(candidate.getFname() + " " + candidate.getLname());
											%>
										</div>
										<div class="col-5">
											<%
											...
											%>
												<strong>Just New/Zero Schedule</strong>

											<%
											} else if (candidate.getCandidate_status() == 1) {
											%>
												<strong>Interviews_OnGoing</strong>
											<%
											...
											%>
												<strong>Offer-Letter-Given</strong>
											<%
											}
											else if (candidate.getCandidate_status() == 5) {
											%>
												<strong>Offer-Letter-Accepted</strong>
											<%
											}
											else if (candidate.getCandidate_status() == 6) {
											%>
												<strong>Offer-Letter-Rejected</strong>
											<%
											}
										...
										<div class="col-2">
											<form action="openprofilepage" method="post">
												<input type="hidden" name="candidate_id" value="<%=candidate.getCandidate_id()%>"> <input class="btn btn-primary" type="submit" value="Open Profile">
											</form>
										</div>
									</div>
									<hr>
	...
	<script>
		function removeErrorofDate(id) {
			...
			document.getElementById("sdatemsg").innerHTML = startDate.value;
			document.getElementById("edatemsg").innerHTML = endDate.value;
